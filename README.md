...
Much can be said about web applications. ASP.NET provides an excellent foundation/framework for developing web apps in C#. ASP.NET is used not only in MVC apps, but also WebAPI's, and also, recently, Blazor. Blazor seems very interesting - a quick way to build SPA's and functional web apps. Quite similar to React, and what it's trying to do.
